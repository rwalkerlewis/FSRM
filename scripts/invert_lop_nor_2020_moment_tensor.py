...
def generate_synthetic_data():
    ...
    Uses a small explosion-like moment tensor (roughly mb 2.7).
    """
...
def main():
    ...
    print("\nGenerating figures...")
    interpretation = [
        "  Lop Nor test site — former Chinese nuclear proving ground",
        "  Large positive ISO → underground explosion signature",
        "  Small CLVD expected from cavity collapse/spall",
    ]
