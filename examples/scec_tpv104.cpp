/*
 * SCEC TPV104: Inelastic Benchmark - Viscoplasticity
 * 
 * Configuration-driven benchmark simulation.
 * All parameters specified in config/scec_tpv104.config
 * 
 * Reference: https://strike.scec.org/cvws/tpv104docs.html
 */

#include "Simulator.hpp"
#include <iostream>

static char help[] = "SCEC TPV104: Viscoplasticity\n";
...
int main(int argc, char** argv) {
    ...
    char config_file[PETSC_MAX_PATH_LEN] = "config/scec_tpv104.config";
    PetscOptionsGetString(nullptr, nullptr, "-c", config_file,
                         sizeof(config_file), nullptr);
    
    if (rank == 0) {
        std::cout << "SCEC TPV104 Benchmark - Viscoplasticity\n";
