/*
 * SCEC TPV37: Bimaterial Interface - Rate-State
 * 
 * Configuration-driven benchmark simulation.
 * All parameters specified in config/scec_tpv37.config
 * 
...
static char help[] = "SCEC TPV37: Bimaterial Rate-State\n";
...
int main(int argc, char** argv) {
    ...
    char config_file[PETSC_MAX_PATH_LEN] = "config/scec_tpv37.config";
    PetscOptionsGetString(nullptr, nullptr, "-c", config_file,
                         sizeof(config_file), nullptr);
    
    if (rank == 0) {
        std::cout << "SCEC TPV37 Benchmark - Bimaterial Rate-State\n";
