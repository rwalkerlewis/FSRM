/*
 * SCEC TPV34: Off-Fault Plasticity - Homogeneous Stress
 * 
 * Configuration-driven benchmark simulation.
 * All parameters specified in config/scec_tpv34.config
 * 
...
static char help[] = "SCEC TPV34: Off-Fault Plasticity\n";
...
int main(int argc, char** argv) {
    ...
    char config_file[PETSC_MAX_PATH_LEN] = "config/scec_tpv34.config";
    PetscOptionsGetString(nullptr, nullptr, "-c", config_file,
                         sizeof(config_file), nullptr);
    
    if (rank == 0) {
        std::cout << "SCEC TPV34 Benchmark - Off-Fault Plasticity\n";
