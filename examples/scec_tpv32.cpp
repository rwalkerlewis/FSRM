 ...
 * All parameters specified in config/scec_tpv32.config
 * 
...
static char help[] = "SCEC TPV32: Normal Fault Free Surface\n";
...
int main(int argc, char** argv) {
    ...
    char config_file[PETSC_MAX_PATH_LEN] = "config/scec_tpv32.config";
    PetscOptionsGetString(nullptr, nullptr, "-c", config_file,
                         sizeof(config_file), nullptr);
    
    if (rank == 0) {
        std::cout << "SCEC TPV32 Benchmark - Normal Fault Free Surface\n";
