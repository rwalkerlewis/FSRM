/*
 * SCEC TPV29: Free Surface with Topography
 * 
 * Configuration-driven benchmark simulation.
 * All parameters specified in config/scec_tpv29.config
 * 
 * Reference: https://strike.scec.org/cvws/tpv29docs.html
 */

#include "Simulator.hpp"
#include <iostream>

static char help[] = "SCEC TPV29: Topography\n";
...
int main(int argc, char** argv) {
    ...
    char config_file[PETSC_MAX_PATH_LEN] = "config/scec_tpv29.config";
    PetscOptionsGetString(nullptr, nullptr, "-c", config_file,
                         sizeof(config_file), nullptr);
    
    if (rank == 0) {
        std::cout << "SCEC TPV29 Benchmark - Topography\n";
