#!/usr/bin/env python3
"""05_synthetic_vs_observed.py -- Cannikin 1971
...
the synthetic and from tools/waveform_vv/cache/cannikin_1971/ for the
observed.
...
CACHE_DIR = REPO / "tools" / "waveform_vv" / "cache" / "cannikin_1971"

# Station identifiers in the cache; pick three as the comparison set.
DEFAULT_STATIONS = ["CAN_1", "CAN_2", "CAN_3"]
