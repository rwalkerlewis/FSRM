/*
 * SCEC TPV8: 3D Strike-Slip with Rate-Dependent Friction
 * 
 * Configuration-driven benchmark simulation.
 * All parameters specified in config/scec_tpv8.config
 * 
 * Reference: https://strike.scec.org/cvws/tpv8docs.html
 */

#include "Simulator.hpp"
#include <iostream>

static char help[] = "SCEC TPV8: Rate-Dependent Friction\n";
...
int main(int argc, char** argv) {
    ...
    char config_file[PETSC_MAX_PATH_LEN] = "config/scec_tpv8.config";
    PetscOptionsGetString(nullptr, nullptr, "-c", config_file,
                         sizeof(config_file), nullptr);
    
    if (rank == 0) {
        std::cout << "SCEC TPV8 Benchmark - Rate-Dependent Friction\n";
