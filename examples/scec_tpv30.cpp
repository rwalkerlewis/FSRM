/*
 * SCEC TPV30: Heterogeneous Initial Stress
 * 
 * Configuration-driven benchmark simulation.
 * All parameters specified in config/scec_tpv30.config
 * 
...
int main(int argc, char** argv) {
    ...
    char config_file[PETSC_MAX_PATH_LEN] = "config/scec_tpv30.config";
    PetscOptionsGetString(nullptr, nullptr, "-c", config_file,
                         sizeof(config_file), nullptr);
    
    if (rank == 0) {
        std::cout << "SCEC TPV30 Benchmark - Heterogeneous Stress\n";
