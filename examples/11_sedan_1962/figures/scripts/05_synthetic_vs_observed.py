#!/usr/bin/env python3
"""05_synthetic_vs_observed.py -- Sedan 1962
...
the synthetic and from tools/waveform_vv/cache/sedan_1962/ for the
observed.
...
CACHE_DIR = REPO / "tools" / "waveform_vv" / "cache" / "sedan_1962"

# Station identifiers in the cache; pick three as the comparison set.
DEFAULT_STATIONS = ["SDC_1", "SDC_2", "SDC_3"]
...
def main():
    ...
    fig.suptitle("Sedan 1962: synthetic vs observed (0.5-5 Hz band)",
                 y=1.00)
