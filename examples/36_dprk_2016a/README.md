# Example 36: DPRK 2016a (January) Nuclear Test

## Physics
Elastodynamic wave propagation through the Mt. Mantap granite column.
Models the ~10 kt (USGS mb 5.1) DPRK event of 2016-01-06 at ~600 m
depth in Punggye-ri -- similar in scale to the 2013 shot.
...
`examples/36_dprk_2016a/config.config`. USGS event listing for the
2016-01-06 detection.

## Config
Uses `examples/36_dprk_2016a/config.config`.

## Expected Output
- `output/dprk_2016a/*.SAC` -- synthetic seismograms at 3 stations
...
## Verified By
- `Integration.HistoricNuclear.DPRK2016a` -- Mt. Mantap granite + SAC output
