/*
 * SCEC TPV14: Branching Fault - Main Fault Dominant
 * 
 * Configuration-driven benchmark simulation.
 * All parameters specified in config/scec_tpv14.config
 * 
...
static char help[] = "SCEC TPV14: Branching Fault - Main Dominant\n";
...
int main(int argc, char** argv) {
    ...
    char config_file[PETSC_MAX_PATH_LEN] = "config/scec_tpv14.config";
    PetscOptionsGetString(nullptr, nullptr, "-c", config_file,
                         sizeof(config_file), nullptr);
    
    if (rank == 0) {
        std::cout << "SCEC TPV14 Benchmark - Branch Fault Main Dominant\n";
