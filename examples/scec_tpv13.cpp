/*
 * SCEC TPV13: 60-Degree Dipping Normal Fault with Rate-State Friction
 * 
 * Configuration-driven benchmark simulation.
 * All parameters specified in config/scec_tpv13.config
 * 
...
static char help[] = "SCEC TPV13: Dipping Fault with Rate-State Friction\n";
...
int main(int argc, char** argv) {
    ...
    char config_file[PETSC_MAX_PATH_LEN] = "config/scec_tpv13.config";
    PetscOptionsGetString(nullptr, nullptr, "-c", config_file,
                         sizeof(config_file), nullptr);
    
    if (rank == 0) {
        std::cout << "SCEC TPV13 Benchmark - Dipping Fault Rate-State\n";
