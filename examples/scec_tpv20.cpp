/*
 * SCEC TPV20: Shallow Dip-Slip - Slip-Weakening
 * 
 * Configuration-driven benchmark simulation.
 * All parameters specified in config/scec_tpv20.config
 * 
...
static char help[] = "SCEC TPV20: Shallow Dip-Slip\n";
...
int main(int argc, char** argv) {
    ...
    char config_file[PETSC_MAX_PATH_LEN] = "config/scec_tpv20.config";
    PetscOptionsGetString(nullptr, nullptr, "-c", config_file,
                         sizeof(config_file), nullptr);
    
    if (rank == 0) {
        std::cout << "SCEC TPV20 Benchmark - Shallow Dip-Slip\n";
