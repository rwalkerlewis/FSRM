/*
 * SCEC TPV102: Inelastic Benchmark - Enhanced Plasticity
 * 
 * Configuration-driven benchmark simulation.
 * All parameters specified in config/scec_tpv102.config
 * 
 * Reference: https://strike.scec.org/cvws/tpv102docs.html
 */

#include "Simulator.hpp"
#include <iostream>

static char help[] = "SCEC TPV102: Inelastic Enhanced Plasticity\n";
...
int main(int argc, char** argv) {
    ...
    char config_file[PETSC_MAX_PATH_LEN] = "config/scec_tpv102.config";
    PetscOptionsGetString(nullptr, nullptr, "-c", config_file,
                         sizeof(config_file), nullptr);
    
    if (rank == 0) {
        std::cout << "SCEC TPV102 Benchmark - Enhanced Plasticity\n";
