#!/usr/bin/env python3
"""05_synthetic_vs_observed.py -- Salmon 1964
...
the synthetic and from tools/waveform_vv/cache/salmon_1964/ for the
observed.
...
CACHE_DIR = REPO / "tools" / "waveform_vv" / "cache" / "salmon_1964"

# Station identifiers in the cache; pick three as the comparison set.
DEFAULT_STATIONS = ["LRSM_1", "LRSM_2", "LRSM_3"]
...
def main():
    ...
    fig.suptitle("Salmon 1964: synthetic vs observed (0.5-5 Hz band)",
                 y=1.00)
