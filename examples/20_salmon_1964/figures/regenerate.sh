#!/bin/bash
# examples/20_salmon_1964/figures/regenerate.sh
#
# Regenerate the showcase figure pack from the existing simulation
# output directories. Does NOT run the simulation. Use run_showcase.sh
...
echo "=== Regenerating Salmon 1964 showcase figures ==="
