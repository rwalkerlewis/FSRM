/*
 * SCEC TPV19: Self-Healing Slip Pulse
 * 
 * Configuration-driven benchmark simulation.
 * All parameters specified in config/scec_tpv19.config
 * 
 * Reference: https://strike.scec.org/cvws/tpv19docs.html
 */

#include "Simulator.hpp"
#include <iostream>

static char help[] = "SCEC TPV19: Self-Healing Pulse\n";
...
int main(int argc, char** argv) {
    ...
    char config_file[PETSC_MAX_PATH_LEN] = "config/scec_tpv19.config";
    PetscOptionsGetString(nullptr, nullptr, "-c", config_file,
                         sizeof(config_file), nullptr);
    
    if (rank == 0) {
        std::cout << "SCEC TPV19 Benchmark - Self-Healing Pulse\n";
