 ...
 * All parameters specified in config/scec_tpv31.config
 * 
...
static char help[] = "SCEC TPV31: Friction Heterogeneity\n";
...
int main(int argc, char** argv) {
    ...
    char config_file[PETSC_MAX_PATH_LEN] = "config/scec_tpv31.config";
    PetscOptionsGetString(nullptr, nullptr, "-c", config_file,
                         sizeof(config_file), nullptr);
    
    if (rank == 0) {
        std::cout << "SCEC TPV31 Benchmark - Friction Heterogeneity\n";
