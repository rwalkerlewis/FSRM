#!/usr/bin/env python3
"""05_synthetic_vs_observed.py -- Sterling 1966
...
the synthetic and from tools/waveform_vv/cache/sterling_1966/ for the
observed.
...
CACHE_DIR = REPO / "tools" / "waveform_vv" / "cache" / "sterling_1966"

# Station identifiers in the cache; pick three as the comparison set.
DEFAULT_STATIONS = ["STR_1", "STR_2", "STR_3"]
...
def main():
    ...
    fig.suptitle("Sterling 1966: synthetic vs observed (0.5-5 Hz band)",
                 y=1.00)
