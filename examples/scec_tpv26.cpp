/*
 * SCEC TPV26: Thermal Pressurization - Homogeneous
 * 
 * Configuration-driven benchmark simulation.
 * All parameters specified in config/scec_tpv26.config
 * 
...
static char help[] = "SCEC TPV26: Thermal Pressurization\n";
...
int main(int argc, char** argv) {
    ...
    char config_file[PETSC_MAX_PATH_LEN] = "config/scec_tpv26.config";
    PetscOptionsGetString(nullptr, nullptr, "-c", config_file,
                         sizeof(config_file), nullptr);
    
    if (rank == 0) {
        std::cout << "SCEC TPV26 Benchmark - Thermal Pressurization\n";
