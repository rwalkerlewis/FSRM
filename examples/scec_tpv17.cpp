/*
 * SCEC TPV17: Subshear to Supershear Transition
 * 
 * Configuration-driven benchmark simulation.
 * All parameters specified in config/scec_tpv17.config
 * 
 * Reference: https://strike.scec.org/cvws/tpv17docs.html
 */

#include "Simulator.hpp"
#include <iostream>

static char help[] = "SCEC TPV17: Supershear Transition\n";
...
int main(int argc, char** argv) {
    ...
    char config_file[PETSC_MAX_PATH_LEN] = "config/scec_tpv17.config";
    PetscOptionsGetString(nullptr, nullptr, "-c", config_file,
                         sizeof(config_file), nullptr);
    
    if (rank == 0) {
        std::cout << "SCEC TPV17 Benchmark - Supershear Transition\n";
